...
- 使用 `novel.txt` 文件记录编写的小说正文内容，包括所有章节和情节发展，**读取`novel.txt`的时候，需要指定从文件多少行读取到文件多少行，不要全部读取。**
...
- 你的思考应该是深入的，所以很长是可以的。将 total_thoughts 设置为至少3，但设置到10也是可以的。当你考虑多种可能的情节发展或角色动机时，你需要更多的思考次数。
